...
@property (nonatomic, strong) UIColor * _Null_unspecified boxes_transparent;
@property (nonatomic, strong) UIColor * _Null_unspecified boxes_transparent_innerborder;
...
typedef SWIFT_ENUM(NSInteger, antispoofFaceThreshold, open) {
  ...
  antispoofFaceThresholdHIGH = 3,
  antispoofFaceThresholdVERY_HIGH = 4,
  antispoofFaceThresholdNONE = 5,
};
